...
# Parameter to decide whether to load parameters from JSON or run iterations when trainning
load_from_json = True  # Set to False to run iterations instead
best_model_json = 'best_model_details_0.774003317745192_0.7684926767385539.json'
...
if(LOAD_MODEL):
    if load_from_json:
        ...
        for iteration in range(X):  # Number of iterations
...
predictions_file_path = 'RF_test_predictions.xlsx'
